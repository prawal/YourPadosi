...
public class MyPadosi extends Activity {
	 MyHorizontalScrollView scrollView;
	  View menu;
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        ViewGroup tabBar = (ViewGroup) app.findViewById(R.id.tabBar3);
	    ...
	    //    ViewUtils.initListView(this, listView, "Menu ", 30, android.R.layout.simple_list_item_1);
	     ...
	     new GetMyPadosi().execute();
	        ...
	        btnSlide = (ImageView) tabBar.findViewById(R.id.BtnSlide3);
	   btnSlide.setOnClickListener(new ClickListenerForScrolling(scrollView, menu));
		...
		class GetMyPadosi extends AsyncTask<Void, Void, Void> {
			...
			protected void onPreExecute() {
				pDialog = ProgressDialog.show(MyPadosi.this, null,
				...
				if(listView1!=null){
				 ...
				 listView1.setOnItemClickListener(new OnItemClickListener() {
			         ...
			         public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			        	 ...
			        	 Intent intent = new Intent(MyPadosi.this, MypadosiDetails.class);
