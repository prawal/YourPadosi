...
import com.example.hpslide.MyHorizontalScrollView.MyOnGlobalLayoutListener;
...
public class MyHorizontalScrollMessege extends HorizontalScrollView {
    public MyHorizontalScrollMessege(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public MyHorizontalScrollMessege(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MyHorizontalScrollMessege(Context context) {
        super(context);
        init(context);
    }
   ...
   /* class MyOnGlobalLayoutListener implements OnGlobalLayoutListener {
       ...
       /* public MyOnGlobalLayoutListener(ViewGroup parent, View[] children, int scrollToViewIdx, SizeCallback sizeCallback) {
        ...
        public void onGlobalLayout() {
            ...
            final HorizontalScrollView me = MyHorizontalScrollMessege.this;
